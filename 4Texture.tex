...
\subsubsection{Scene completion}
...
We thus exploit our planar primitive abstraction to simplify 3D scene completion.%, as it can be extrapolated to 
\begin{figure}
    \centering
...
\subsubsection{Texture Optimization}% of the Texture and the Metric}
